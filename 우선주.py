...
fig_sum = go.Figure()
fig_sum.add_trace(go.Histogram(x=x250, name="1년", bins=30))
fig_sum.add_trace(go.Histogram(x=x120, name="반기", bins=30))
fig_sum.add_trace(go.Histogram(x=x60, name="분기", bins=30))
fig_sum.add_trace(go.Histogram(x=x20, name="1달", bins=30))
