...
fig_sum = go.Figure()
fig_sum.add_trace(go.Histogram(x=x250, name="1년", nbins=30))
fig_sum.add_trace(go.Histogram(x=x120, name="반기", nbins=30))
fig_sum.add_trace(go.Histogram(x=x60, name="분기", nbins=30))
fig_sum.add_trace(go.Histogram(x=x20, name="1달", nbins=30))
